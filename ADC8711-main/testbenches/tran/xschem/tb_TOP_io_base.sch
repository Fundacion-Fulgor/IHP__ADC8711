...
C {Counters_6bits.sym} 5790 -420 0 0 {name=x1
}
C {Counters_regs_6bits.sym} 6230 -390 0 0 {name=x6
}
C {Counter_FA_6bits.sym} 5430 -210 0 0 {name=x7
}
C {Counter_FA_7bits.sym} 5630 -130 0 0 {name=x3
}
...
C {Counters__FA_regs_7bits.sym} 6290 -180 0 0 {name=x9
}
...
C {SR_Latch.sym} 6060 -850 0 0 {name=x10}
