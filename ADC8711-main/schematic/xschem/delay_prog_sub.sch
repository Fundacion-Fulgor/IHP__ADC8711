...
C {lab_wire.sym} 220 -240 0 1 {name=p6 sig_type=std_logic lab=CTRL[0]
}
C {lab_wire.sym} 220 -80 0 1 {name=p7 sig_type=std_logic lab=CTRLN[0]
}
C {lab_wire.sym} 180 -20 0 0 {name=p8 sig_type=std_logic lab=VDD
}
C {lab_wire.sym} 220 140 0 1 {name=p9 sig_type=std_logic lab=CTRLN[1]
}
C {lab_wire.sym} 180 140 0 0 {name=p10 sig_type=std_logic lab=VSS
}
C {lab_wire.sym} 220 -20 0 1 {name=p11 sig_type=std_logic lab=CTRL[1]
}
...
C {lab_wire.sym} 220 360 0 1 {name=p13 sig_type=std_logic lab=CTRLN[2]
}
C {lab_wire.sym} 180 360 0 0 {name=p14 sig_type=std_logic lab=VSS
}
C {lab_wire.sym} 220 200 0 1 {name=p15 sig_type=std_logic lab=CTRL[2]
}
