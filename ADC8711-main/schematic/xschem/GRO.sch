...
N 1160 -600 1200 -600 {lab=G}
N 420 -600 460 -600 {lab=EN}
N 510 -560 510 -540 {lab=VSS}
N 680 -560 680 -540 {lab=VSS}
N 890 -560 890 -540 {lab=VSS}
N 1090 -560 1090 -540 {lab=VSS}
N 510 -660 510 -640 {lab=VDD}
N 680 -660 680 -640 {lab=VDD}
N 890 -660 890 -640 {lab=VDD}
N 1090 -660 1090 -640 {lab=VDD}
...
N 580 -700 580 -600 {lab=2*net1}
N 630 -700 630 -600 {lab=4*net1}
N 750 -700 750 -600 {lab=4*net2}
N 840 -700 840 -600 {lab=8*net2}
N 960 -700 960 -600 {lab=8*net3}
N 1040 -700 1040 -600 {lab=16*net3}
...
C {INV_D1.sym} 800 -460 0 0 {name=x7[7:0]}
C {INV_D1.sym} 1000 -460 0 0 {name=x8[15:0]}
...
C {lab_wire.sym} 890 -540 0 0 {name=p25 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 1090 -540 0 0 {name=p26 sig_type=std_logic lab=VSS}
...
C {lab_wire.sym} 890 -660 0 0 {name=p29 sig_type=std_logic lab=VDD
}
C {lab_wire.sym} 1090 -660 0 0 {name=p30 sig_type=std_logic lab=VDD
}
C {lab_wire.sym} 1200 -600 0 1 {name=p31 sig_type=std_logic lab=G
}
...
C {lab_wire.sym} 580 -700 0 0 {name=p22 sig_type=std_logic lab=2*net1
}
C {lab_wire.sym} 630 -700 0 0 {name=p39 sig_type=std_logic lab=4*net1
}
C {lab_wire.sym} 750 -700 0 0 {name=p40 sig_type=std_logic lab=4*net2
}
C {lab_wire.sym} 840 -700 0 0 {name=p41 sig_type=std_logic lab=8*net2
}
C {lab_wire.sym} 960 -700 0 0 {name=p42 sig_type=std_logic lab=8*net3

}
C {lab_wire.sym} 1040 -700 0 0 {name=p43 sig_type=std_logic lab=16*net3
}
