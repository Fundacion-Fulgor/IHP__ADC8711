...
N 1530 -680 1570 -680 {lab=CTRL[0]}
N 1530 -640 1570 -640 {lab=CTRL[1]}
...
C {lab_wire.sym} 1530 -680 0 0 {name=p88 sig_type=std_logic lab=CTRL[0]
}
C {sg13g2_hv_antennanp.sym} 1660 -680 0 0 {name=x12 VDD=VDD VSS=VSS prefix=sg13g2_hv_ }
C {lab_wire.sym} 1530 -640 0 0 {name=p89 sig_type=std_logic lab=CTRL[1]
}
C {sg13g2_hv_antennanp.sym} 1660 -640 0 0 {name=x13 VDD=VDD VSS=VSS prefix=sg13g2_hv_ }
C {lab_wire.sym} 1530 -600 0 0 {name=p90 sig_type=std_logic lab=CTRL[2]
}
C {sg13g2_hv_antennanp.sym} 1660 -600 0 0 {name=x14 VDD=VDD VSS=VSS prefix=sg13g2_hv_ }
C {lab_wire.sym} 1530 -560 0 0 {name=p91 sig_type=std_logic lab=START
}
C {sg13g2_hv_antennanp.sym} 1660 -560 0 0 {name=x15 VDD=VDD VSS=VSS prefix=sg13g2_hv_ }
C {lab_wire.sym} 1530 -520 0 0 {name=p92 sig_type=std_logic lab=STOP
}
C {sg13g2_hv_antennanp.sym} 1660 -520 0 0 {name=x16 VDD=VDD VSS=VSS prefix=sg13g2_hv_ }
C {lab_wire.sym} 1530 -480 0 0 {name=p93 sig_type=std_logic lab=RESET
}
C {sg13g2_hv_antennanp.sym} 1660 -480 0 0 {name=x17 VDD=VDD VSS=VSS prefix=sg13g2_hv_ }
C {fillers.sym} 1610 -290 0 0 {name=x19[799:0]}
C {lab_wire.sym} 1790 -300 0 0 {name=p97 sig_type=std_logic lab=VDD
}
C {lab_wire.sym} 1790 -280 0 0 {name=p99 sig_type=std_logic lab=VSS
}
